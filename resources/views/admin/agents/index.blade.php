    ...
    <table class="min-w-full divide-y divide-gray-200">
        <thead class="bg-gray-50">
            <tr>
                ...
                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Mini-site</th>
        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr>
                <td class="px-6 py-4 whitespace-nowrap">
                    <div class="flex items-center">
                        <div class="flex-shrink-0 h-10 w-10">
                            @if($agent->photo)
                                <img class="h-10 w-10 rounded-full object-cover" src="{{ Storage::url($agent->photo) }}" alt="{{ $agent->nom_complet }}">
                            @else
                        ...
                        <div class="ml-4">
                            ...
                            <div class="text-sm text-gray-500">{{ $agent->slug }}</div>
                        </div>
                    </div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm">
                    <a href="{{ $agent->url }}" target="_blank" class="text-blue-600 hover:text-blue-900">
                        Voir le site →
                    </a>
                </td>
